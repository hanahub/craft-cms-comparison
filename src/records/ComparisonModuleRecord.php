...
namespace modules\comparisonmodule\records;
 ...
 * @since     1.0.0
 */
class ComparisonModuleRecord extends ActiveRecord
{
    ...
    {
        return '{{%comparisonmodule_comparisonmodulerecord}}';
    }
}
