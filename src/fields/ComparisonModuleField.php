...
namespace modules\comparisonmodule\fields;

use modules\comparisonmodule\ComparisonModule;
use modules\comparisonmodule\assetbundles\comparisonmodulefieldfield\ComparisonModuleFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class ComparisonModuleField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('comparison-module', 'ComparisonModuleField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'comparison-module/_components/fields/ComparisonModuleField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ComparisonModuleFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').ComparisonModuleComparisonModuleField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'comparison-module/_components/fields/ComparisonModuleField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
