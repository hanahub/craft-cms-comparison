...
namespace modules\comparisonmodule\widgets;

use modules\comparisonmodule\ComparisonModule;
use modules\comparisonmodule\assetbundles\comparisonmodulewidgetwidget\ComparisonModuleWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class ComparisonModuleWidget extends Widget
{
    ...
    {
        return Craft::t('comparison-module', 'ComparisonModuleWidget');
    }
    ...
    {
        return Craft::getAlias("@comparisonmodule/assetbundles/comparisonmodulewidgetwidget/dist/img/ComparisonModuleWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'comparison-module/_components/widgets/ComparisonModuleWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ComparisonModuleWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'comparison-module/_components/widgets/ComparisonModuleWidget_body',
            [
